...
class ReportBomStructureBranch(models.AbstractModel):
    ...
    #         # Check if this should be treated as component despite having child_bom
    #         treat_as_component = (
    ...
    #                 data[
    #                     'product_manufacturer_id'] = bom_line.product_manufacturer_id.id if bom_line.product_manufacturer_id else False
    ...
    #                 if bom_line.approval_1 and bom_line.approval_2:
